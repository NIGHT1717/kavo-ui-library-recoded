...
local function UpdateTabCanvas()
    local sizeY = tabListing.AbsoluteContentSize.Y + 12
    tabFrames.CanvasSize = UDim2.new(0, 0, 0, sizeY)
end

tabListing:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(UpdateTabCanvas)
coroutine.wrap(function() wait(); UpdateTabCanvas() end)()
